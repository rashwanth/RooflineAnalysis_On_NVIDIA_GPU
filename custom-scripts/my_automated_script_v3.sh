...
ncu --section SpeedOfLight_HierarchicalDoubleRooflineChart --export "$output" -f ./gpp.x "$input"
...
for i in {1..8}; do
    ...
    ncu --section SpeedOfLight_HierarchicalDoubleRooflineChart --export "$output_rep" -f ./gpp.x "$input"
done
